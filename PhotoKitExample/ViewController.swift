...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource  {
    ...
    func collectionView(collectionView: UICollectionView!, cellForItemAtIndexPath indexPath: NSIndexPath!) -> UICollectionViewCell! {
        ...
        self.fetchImageAtIndex(indexPath, withSize: cell.cellSize, completionHandler: {(returnImage: UIImage!, info: [NSObject : AnyObject]!) in
        ...
        if let checkedCellAsset = cellAsset {
            PHImageManager.defaultManager().requestImageForAsset(checkedCellAsset, targetSize: cell.cellSize, contentMode: .AspectFill, options: nil, resultHandler:{(image :UIImage!, info :[NSObject : AnyObject]!) in
    ...
    func fetchImageAtIndex(index: NSIndexPath, withSize size: CGSize, completionHandler:(returnImage: UIImage!, info: [NSObject : AnyObject]!) -> Void) {
    ...
    func replaceImageAtIndexPath(indexPath: NSIndexPath, withImage image: UIImage) {
        ...
        if let checkedAsset = asset {
            ...
            checkedAsset.requestContentEditingInputWithOptions(nil, completionHandler:{(input: PHContentEditingInput!, info: [NSObject : AnyObject]!) in
    ...
    func collectionView(collectionView: UICollectionView!, didSelectItemAtIndexPath indexPath: NSIndexPath!) {
        self.fetchImageAtIndex(indexPath, withSize: PHImageManagerMaximumSize, completionHandler:{(assetImage: UIImage!, info: [NSObject : AnyObject]!) in
